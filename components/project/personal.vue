...
<template>
  <div>
    ...
    <el-card class="box-card mt-5">
      ...
      <div
        class="flex gap-5 justify-between sm:flex-wrap-reverse xs:flex-wrap-reverse sm:justify-center"
      >
        <div>
          <LayoutSubTitle>
            <template #title>기간</template>
            <template #content><p>2021.09 ~ 2021.12</p></template>
          </LayoutSubTitle>

          <LayoutSubTitle>
            <template #title>Skill</template>
            <template #content><p>Vue2, Vuetify , Vuex</p></template>
          </LayoutSubTitle>
          ...
          <LayoutSubTitle>
            ...
            <template #content>
              <p>백엔드와 api 연동</p>
              <p>작가홈, 웹툰홈 페이지 제작 및 디자인</p></template
            >
          </LayoutSubTitle>
        </div>
        <nuxt-img
    ...
    <el-card class="box-card mt-5">
      ...
      >
        <div>
          <LayoutSubTitle>
            <template #title>기간</template>
            <template #content><p>2021.03 ~ 2021.07</p></template>
          </LayoutSubTitle>
          <LayoutSubTitle>
            <template #title>Skill</template>
            <template #content><p>HTML5, CSS3, JavaScript</p></template>
          </LayoutSubTitle>
          <LayoutSubTitle>
            <template #title>URL</template>
            <template #content
        ...
        <div>
          ...
          <LayoutSubTitle>
            ...
            <template #content>
              ...
              <p>2021.10 Sw중심대학 공동창업 camp(대상 수상)</p></template
            >
          </LayoutSubTitle>
        </div>
        <nuxt-img
    ...
    <el-card class="box-card mt-5">
      ...
      <div
        class="flex justify-between gap-5 sm:flex-wrap-reverse sm:justify-center"
      >
        <div>
          <LayoutSubTitle>
            <template #title>기간</template>
            <template #content><p>2020.12 ~ 2021.01</p></template>
          </LayoutSubTitle>
          <LayoutSubTitle>
            <template #title>Skill</template>
            <template #content><p>HTML5, CSS3, JavaScript</p></template>
          ...
          <LayoutSubTitle>
            ...
            <template #content
              ...
              <p>댓글 Discuss Api연동</p></template
            >
          </LayoutSubTitle>

          <LayoutSubTitle>
            <template #title>성과</template>
            <template #content><p>카카오 주관 팀 프로젝트 완성</p></template>
          </LayoutSubTitle>
        </div>
        <nuxt-img
          src="/img/jeju.png"
